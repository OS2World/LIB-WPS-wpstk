...
/* When not set in config.sys this is done with a script usually located in 
    ...
    systems use a script called envwatcom.cmd loacated in one of the directories
    in my PATH */
'call envwatcom.cmd'

/* */
'call p:\wpstk170\bin\wtkenv.cmd watcom'
