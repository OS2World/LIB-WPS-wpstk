/* $Id: printf.c,v 1.3 2003-10-22 20:37:11 cla Exp $ */
...
#define PRINTFID      ""
#define PRINTFMAXLEN  2048
#define PRINTFLINELEN 2048
...
#include <time.h>                  /* .. */
#include <stdarg.h>                /* .. */
/* --- change by cla@clanganke.de for WPS Toolkit 2000      */
/* for usage with EMX compiler:                             */
/* - do not incldue stdio.h                                 */
/* - define macro max                                       */
/*   Should be in stdlib.h but is not within EMX...         */
/* Original lines in else part                              */
#ifdef __EMX__
